...
public class SearchResoultActivity extends BaseActivity implements View.OnClickListener
{
    ...
    private void initView()
    {
        ...
        url = NetAddressManager.root_website + NetAddressManager.search + "?keyworld=" + module.tag + "&appVer="
